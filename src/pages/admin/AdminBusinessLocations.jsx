...
const AdminBusinessLocations = () => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl sm:text-2xl font-bold text-slate-800">Business Locations</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-800">{data?.totalProvinces ?? 0}</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-800">{data?.totalDistricts ?? 0}</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-800">{data?.totalBusinesses ?? 0}</p>
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        <div className="p-4 border-b border-slate-200">
          <h2 className="text-base font-semibold text-slate-800">Business Distribution</h2>
        </div>
          ...
          <table className="w-full text-sm">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th className="text-right p-3 font-medium text-slate-600">Active</th>
