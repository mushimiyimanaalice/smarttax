...
const AdminDistrictMonitoring = () => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl sm:text-2xl font-bold text-slate-800">District Monitoring</h1>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
        <h2 className="text-base font-semibold text-slate-800 mb-4">District Comparison</h2>
